...
(
    ...
    localparam PAD8 = log2ceil(64'h1109078 - 64'h1109070);
    localparam PAD9 = log2ceil(64'h1109080 - 64'h1109078);
    localparam PAD10 = log2ceil(64'h1109088 - 64'h1109080);
    localparam PAD11 = log2ceil(64'h110908c - 64'h1109088);
    localparam PAD12 = log2ceil(64'h110908e - 64'h110908c);
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h110908e;
    ...
    always @* begin
        ...
        // ( 0x1109078 .. 0x1109080 )
        if ( {address[RG:PAD9],{PAD9{1'b0}}} == 25'h1109078 ) begin
        ...
        // ( 0x1109088 .. 0x110908c )
        if ( {address[RG:PAD11],{PAD11{1'b0}}} == 25'h1109088 ) begin
            src_channel = 13'b1000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
        end

        // ( 0x110908c .. 0x110908e )
        if ( {address[RG:PAD12],{PAD12{1'b0}}} == 25'h110908c ) begin
